...
struct WelcomeStepView: View {
    ...
    var body: some View {
        OnboardingStepView(
            ...
            subtitle: "Schreib deine Einkaufsliste. Smartshop vergleicht die Wochenangebote deiner Filialen und sagt dir, wo du am besten hinfährst.",
...
struct HouseholdStepView: View {
    ...
    var body: some View {
        ...
        return OnboardingStepView(
            ...
            subtitle: "Grobe Angaben reichen — sie helfen uns, Smartshop passender zu machen.",
            onPrimary: onContinue,
